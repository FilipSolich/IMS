...
const int SLOW_SHIFT_DURATION = 4 * HOUR; // Slow shift length (default 4h)
const int FAST_SHIFT_DURATION = 3 * HOUR; // Fast shift length (default 3h)

const int SLOW_SHIFT_GENERATE = 13; // Slow shift generation new order (default 13m)
const int FAST_SHIFT_GENERATE = 6;  // Fast shift generation new order (default 6m)
